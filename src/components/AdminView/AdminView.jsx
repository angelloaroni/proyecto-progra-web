  ...
  return (
    <section className="admin-view">
      ...
      <div className="admin-options">
        <article className="admin-card" onClick={() => navigate("/admin/register")}>
        ...
        <article className="admin-card" onClick={() => navigate("/admin/claims")}>
          <div className="admin-card-icon">
        ...
        <article className="admin-card" onClick={() => navigate("/admin/users")}>
          <div className="admin-card-icon">
        ...
        <article className="admin-card" onClick={() => navigate("/admin/items")}>
          <div className="admin-card-icon">
